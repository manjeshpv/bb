...
//	db, err := sql.Open("mysql", "jewelry:jewelry1234@tcp(198.71.225.64:3306)/jewelry")
db, err := sql.Open("mysql", "ayyayo_beatle:beatle1234@tcp(188.166.210.246:3306)/ayyayo_beatle")
